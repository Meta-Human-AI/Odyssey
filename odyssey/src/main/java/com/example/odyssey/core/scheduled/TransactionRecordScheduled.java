        ...
        while (true) {
            ...
            for (BscScanTransactionLog bscScanTransactionLog : scanTransactionLogs) {
                ...
                if (bscScanTransactionLog.getFrom().equals("0x0000000000000000000000000000000000000000")) {
                    ...
                    TransactionRecord record = transactionRecordMapper.selectOne(buyQueryWrapper);
                    ...
                    if (bscScanAccountTransaction.getMethodId().equals("0x5a0ce362")) {
                        ...
                        record.setTransactionHash(bscScanTransactionLog.getTransactionHash());
                        record.setAction(ActionTypeEnum.BUY.getCode());
                        record.setActionName(ActionTypeEnum.BUY.getName());
                        record.setBlockNumber(bscScanTransactionLog.getDecodedBlockNumber());
                        record.setType(nftMessage.getType());
                        record.setTokenId(bscScanTransactionLog.getTokenId());
                        record.setLogIndex(bscScanTransactionLog.getLogIndex());
                        record.setWalletAddress(bscScanTransactionLog.getTo());
                        record.setTime(time);
                        ...
                        record = new TransactionRecord();
                        record.setTransactionHash(bscScanTransactionLog.getTransactionHash());
                        record.setAction(ActionTypeEnum.AIRDROP.getCode());
                        record.setActionName(ActionTypeEnum.AIRDROP.getName());
                        record.setBlockNumber(bscScanTransactionLog.getDecodedBlockNumber());
                        record.setType(nftMessage.getType());
                        record.setTokenId(bscScanTransactionLog.getTokenId());
                        record.setLogIndex(bscScanTransactionLog.getLogIndex());
                ...
                if (Objects.nonNull(nftMessageTransferCmd.getBuyAddress())) {
                    ...
                    if (bscScanTransactionLog.getFrom().equals("0x0000000000000000000000000000000000000000")) {
                        nftMessageTransferCmd.setOldAddress(bscScanTransactionLog.getTo());
                    } else {
